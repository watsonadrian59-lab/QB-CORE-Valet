...
RegisterCommand(Config.Command, function()
    TriggerServerEvent('qb-valet:server:GetVehicles')
end)
...
RegisterNetEvent('qb-valet:client:ReceiveVehicles', function(vehicles)
    ...
    for _, v in pairs(vehicles) do
        Menu[#Menu+1] = {
            ...
            params = {
                event = "qb-valet:client:SelectVehicle",
                args = v.plate
            }
        }
    end
...
RegisterNetEvent('qb-valet:client:SelectVehicle', function(plate)
    TriggerServerEvent('qb-valet:server:SpawnVehicle', plate)
end)

RegisterNetEvent('qb-valet:client:SpawnVehicle', function(vehicleData)
